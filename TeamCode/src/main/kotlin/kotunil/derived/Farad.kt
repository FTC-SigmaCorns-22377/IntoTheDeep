...
private val formula =  (kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2)
...
* QF, 10^30 of farad, derived SI-Unit for measurement of capacitance
*/        
val QF = 10.0.pow(30) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* RF, 10^27 of farad, derived SI-Unit for measurement of capacitance
*/        
val RF = 10.0.pow(27) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* YF, 10^24 of farad, derived SI-Unit for measurement of capacitance
*/        
val YF = 10.0.pow(24) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* ZF, 10^21 of farad, derived SI-Unit for measurement of capacitance
*/        
val ZF = 10.0.pow(21) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* EF, 10^18 of farad, derived SI-Unit for measurement of capacitance
*/        
val EF = 10.0.pow(18) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* PF, 10^15 of farad, derived SI-Unit for measurement of capacitance
*/        
val PF = 10.0.pow(15) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* TF, 10^12 of farad, derived SI-Unit for measurement of capacitance
*/        
val TF = 10.0.pow(12) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* GF, 10^9 of farad, derived SI-Unit for measurement of capacitance
*/        
val GF = 10.0.pow(9) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* MF, 10^6 of farad, derived SI-Unit for measurement of capacitance
*/        
val MF = 10.0.pow(6) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* kF, 10^3 of farad, derived SI-Unit for measurement of capacitance
*/        
val kF = 10.0.pow(3) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* hF, 10^2 of farad, derived SI-Unit for measurement of capacitance
*/        
val hF = 10.0.pow(2) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* daF, 10^1 of farad, derived SI-Unit for measurement of capacitance
*/        
val daF = 10.0.pow(1) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* dF, 10^-1 of farad, derived SI-Unit for measurement of capacitance
*/        
val dF = 10.0.pow(-1) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* cF, 10^-2 of farad, derived SI-Unit for measurement of capacitance
*/        
val cF = 10.0.pow(-2) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* mF, 10^-3 of farad, derived SI-Unit for measurement of capacitance
*/        
val mF = 10.0.pow(-3) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* μF, 10^-6 of farad, derived SI-Unit for measurement of capacitance
*/        
val μF = 10.0.pow(-6) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* nF, 10^-9 of farad, derived SI-Unit for measurement of capacitance
*/        
val nF = 10.0.pow(-9) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* pF, 10^-12 of farad, derived SI-Unit for measurement of capacitance
*/        
val pF = 10.0.pow(-12) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* fF, 10^-15 of farad, derived SI-Unit for measurement of capacitance
*/        
val fF = 10.0.pow(-15) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
...
* aF, 10^-18 of farad, derived SI-Unit for measurement of capacitance
*/        
val aF = 10.0.pow(-18) * ((kg   infixPow  -1) * (m   infixPow  -2) * (s  infixPow  4) * (A  infixPow  2))
